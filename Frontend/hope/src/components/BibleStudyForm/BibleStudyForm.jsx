      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex items-center justify-center bg-gray-900">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white">Apply For Bible Study</h1>
            <p className="mt-2 text-gray-400">Join us for bible study today</p>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center bg-gray-50">
          <div className="w-full max-w-md p-8 space-y-6">
            <h2 className="text-3xl font-extrabold text-blue-600 text-center">Bible Study Form</h2>
